            ...
            <div className="space-y-3">
                {loading ? (
                    <div
                        ...
                        style={{ borderColor: 'hsl(var(--border))', color: 'hsl(var(--muted-foreground))', backgroundColor: 'hsl(var(--card))' }}
                    >
                                    ...
                                    <div className="flex items-center gap-2">
                                        {!read ? (
                                            <button
                                                ...
                                                className="rounded-md border px-2.5 py-1 text-xs font-medium transition hover:bg-muted/50"
                                                style={{ borderColor: 'hsl(var(--border))', color: 'hsl(var(--foreground))' }}
                                            >
                                                Mark Read
                                            </button>
