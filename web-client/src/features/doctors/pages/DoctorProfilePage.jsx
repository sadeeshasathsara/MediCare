            ...
            <section className="relative overflow-hidden rounded-2xl border border-border bg-card">
                ...
                <div className="px-5 pb-5">
                    <div className="-mt-10 flex flex-col items-center text-center">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">Manage your doctor profile details.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <section className="rounded-xl border border-border bg-card p-5">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-base font-semibold text-foreground">Professional</h2>
                    </div>

                    <div className="mt-4 grid grid-cols-1 gap-3">
                        <Field label="License" value={''} placeholder="Not set" disabled={true} />
                        <Field label="Specialty" value={''} placeholder="Not set" disabled={true} />
                    </div>
                </section>
            </div>
        </div>
