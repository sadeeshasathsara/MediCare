...
export default function DashboardMetrics({ pendingCount, upcomingCount, slotsCount }) {
  return (
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Confirmed scheduled appointments</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Availability configured</p>
        </CardContent>
      </Card>
    </div>
  );
