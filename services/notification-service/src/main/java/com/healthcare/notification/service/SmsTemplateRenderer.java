...
public class SmsTemplateRenderer {
    ...
    public SmsTemplateRenderer(ResourceLoader resourceLoader) {
    ...
    private String loadTemplate(String templateName) {
        String path = "classpath:templates/sms/" + templateName + ".txt";
        ...
        try (Reader reader = new InputStreamReader(resource.getInputStream(), StandardCharsets.UTF_8)) {
            ...
            throw new IllegalStateException("Failed to load SMS template: " + templateName, ex);
        }
    }
}
